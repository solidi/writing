...
As the mission is clarified, one of the challenging problems I'll solve is to remove work *burdens* and *liabilities*. The team will have work in their queue that doesn't align with the mission. It is on me to work with [product](https://medium.com/hackernoon/the-decision-hypothesis-aa512e0113) and [project management](https://dev.to/solidi/what-is-a-project-manager-anyway-fbb) to refactor away. Creative thinking, rerouting, and renegotiating are my methods. It is always easier to add work than to remove work. To unburden the workstream, to cover, is a skill set I continue to hone for my teams.
