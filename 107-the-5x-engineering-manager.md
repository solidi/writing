...
![Photo by dev.to automation](images/107-01.jpeg)
...
NOW I SIT in the manager's seat. Years of being an [engineering manager](https://dev.to/solidi/what-is-an-engineering-manager-anyway-4and) have given me a different perspective. While the 10x engineer is measured by getting things done, the 5x manager is measured by multiplying the team’s output through hiring, delegation, conflict, praise, and delivery.
...
**They delegate ruthlessly.** A 10x engineer can do it all themselves, while a 5x manager refuses to. They paint the picture of being done, hand it to a [lead](https://dev.to/solidi/what-is-a-tech-lead-anyway-483p), and manage the expectations. The instinct to grab the keyboard is the hardest one to retire.
...
**They praise on the record.** The work itself fuels a 10x engineer. A 5x manager is fueled by [catching others doing the right thing](https://dev.to/solidi/what-is-an-engineering-manager-anyway-4and) and saying it out loud, in writing, or in front of the org. The 5x part is doing it five times more often than feels natural.
...
The 10x engineer ships ten engineers' worth of code. The 5x manager picks one of five meetings happening at the same minute, walks in three minutes late, and asks what they missed.

Both are real. Only one has a calendar problem.
